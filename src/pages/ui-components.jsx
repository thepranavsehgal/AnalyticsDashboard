            ...
            <div className="layout-specing">
                ...
                <div className="grid md:grid-cols-12 mt-6 gap-6 relative">
                    <div className="xl:col-span-3 md:col-span-4">
                        <div className="rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900 p-6 sticky top-20">
                            <ul className="list-none sidebar-nav mb-0 py-0" id="navmenu-nav">
                                <li className="navbar-item p-0"><Link to="#buttons" className="text-base font-medium navbar-link">UI Buttons</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#badges" className="text-base font-medium navbar-link">UI Badges</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#alerts" className="text-base font-medium navbar-link">UI Alerts</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#dropdowns" className="text-base font-medium navbar-link">UI Dropdowns</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#text-colors" className="text-base font-medium navbar-link">UI Text Colors</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#backgrounds" className="text-base font-medium navbar-link">UI Background Colors</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#accordions" className="text-base font-medium navbar-link">UI Accordions Colors</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#nav-tabs" className="text-base font-medium navbar-link">UI Nav Tabs</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#form-inputs" className="text-base font-medium navbar-link">UI Form Elements</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#shadows" className="text-base font-medium navbar-link">UI Shadow</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#borders" className="text-base font-medium navbar-link">UI Borders</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#breadcrumbs" className="text-base font-medium navbar-link">UI Breadcrumbs</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#paginations" className="text-base font-medium navbar-link">UI Paginations</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#modals" className="text-base font-medium navbar-link">UI Modals</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#tables" className="text-base font-medium navbar-link">UI Tables</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#headings" className="text-base font-medium navbar-link">UI Headings</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#font-weights" className="text-base font-medium navbar-link">UI Font Weights</Link></li>
                                <li className="navbar-item mt-3 p-0"><Link to="#icons" className="text-base font-medium navbar-link">UI Icons</Link></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div className="grid grid-cols-1 gap-[30px]">
                                    ...
                                    <div className="shadow dark:shadow-slate-800 rounded bg-white dark:bg-slate-900">
                                        ...
                                        <div className="p-5 border-t border-gray-100 dark:border-slate-800">
                                            <ul className="list-none">
                                                <li className="inline-block m-0.5">
                                                    <Link to="" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><Icon.ShoppingCart className="h-4 w-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link to="" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><Icon.ShoppingCart className="h-4 w-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link to="" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-transparent hover:bg-indigo-600 border-indigo-600 text-indigo-600 hover:text-white"><Icon.ShoppingCart className="h-4 w-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link to="" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border bg-transparent hover:bg-indigo-600 border-indigo-600 text-indigo-600 hover:text-white"><Icon.ShoppingCart className="h-4 w-4"/></Link>
                                                </li>
                                                ...
                                                <li className="inline-block m-0.5">
                                                    <Link to="" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-md border bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white"><Icon.ShoppingCart className="h-4 w-4"/></Link>
                                                </li>
                                                
                                                <li className="inline-block m-0.5">
                                                    <Link to="" className="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white"><Icon.ShoppingCart className="h-4 w-4"/></Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
