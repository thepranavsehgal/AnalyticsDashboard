      ...
      <div className=" sidebar-content">
        ...
        <SimpleBarReact style={{ height: "calc(100% - 70px)" }}>
          <ul className="sidebar-menu border-t border-white/10">
            ...
            <li className="relative lg:m-8 m-6 px-8 py-10 rounded-lg bg-gradient-to-b to-transparent from-indigo-700 text-center">
              <span className="relative z-10">
                <span className="text-xl font-bold h5 text-white">
                  Upgrade to Pro
                </span>
                ...
                <Link
                  ...
                  target="_blank"
                  className="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-700/50 hover:bg-indigo-700 border-indigo-700/50 hover:border-indigo-700 text-white rounded-md"
                >
                  Subscribe
                </Link>
              </span>
